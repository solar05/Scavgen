...
class SavageGenerator
{
    ...
    protected $firstNames = [
        ...
        'Костыль', 'Гарри', 'Ким', 'Эврар', 'Эрнест'];
    ...
    protected $lastNames = [
        ...
        'Моцарелла', 'Крайний', 'Промах', 'Открывашка', 'Масорубка', 'Лаврушка',
        ...
        'Комбайн', 'Низкокаллорийный', 'Чайка', 'Каратель', 'Ломакин];
    protected $legendaryNames = [
        ...
        'Леха Лепёха', 'Жан Кожан', 'Клим Саныч'
    ];
