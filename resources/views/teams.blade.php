...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link blended-reg bg-secondary text-white rounded" href="{{ route('team') }}">Собрать отряд</a>
    ...
    <div class="container border border-dark rounded">
        <div class="jumbotron">
            ...
            <br>
            <p class="lead">
                <a class="btn btn-success btn-lg d-flex justify-content-center blended-reg" href="{{ route('team') }}" role="button">Сгенерировать отряд диких</a>
            </p>
        </div>
    </div>
    </body>
